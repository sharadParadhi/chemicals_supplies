...
const chemicalSupplies =JSON.parse(localStorage.getItem('chemicalSupplies')) || [
    { id: 1, chemicalName: "Ammonium Persulfate", vendor: "LG Chem", density: 3525.92, viscosity: 60.631, packaging: "Bag", packSize: "100.00", unit: "kg", quantity: 6495.18 },
    ...
    { id: 4, chemicalName: "Mono Ammonium Phosphate", vendor: "Sinopec", density: 1597.66, viscosity: 76.54, packaging: "Bag", packSize: "105.00", unit: "kg", quantity: 8183.73 },
    ...
    { id: 8, chemicalName: "Ethylene Glycol", vendor: "Sinopec", density: 1112.5, viscosity: 34.78, packaging: "Drum", packSize: "200.00", unit: "L", quantity: 3254.10 },
    { id: 9, chemicalName: "Sulfuric Acid", vendor: "BASF", density: 1840.00, viscosity: 26.75, packaging: "Barrel", packSize: "150.00", unit: "L", quantity: 7529.48 },
    { id: 10, chemicalName: "Sodium Hydroxide", vendor: "Formosa", density: 2195.42, viscosity: 50.15, packaging: "Bag", packSize: "100.00", unit: "kg", quantity: 6548.26 },
    { id: 11, chemicalName: "Acetic Acid", vendor: "LG Chem", density: 1050.12, viscosity: 12.63, packaging: "Barrel", packSize: "125.00", unit: "L", quantity: 4910.87 },
    { id: 12, chemicalName: "Hydrogen Peroxide", vendor: "DowDuPont", density: 1450.74, viscosity: 28.55, packaging: "Canister", packSize: "50.00", unit: "L", quantity: 8451.00 },
    { id: 13, chemicalName: "Phosphoric Acid", vendor: "Sinopec", density: 1503.33, viscosity: 65.72, packaging: "Drum", packSize: "210.00", unit: "L", quantity: 5542.65 },
    { id: 14, chemicalName: "Chloroform", vendor: "LG Chem", density: 1467.88, viscosity: 53.20, packaging: "Bottle", packSize: "10.00", unit: "L", quantity: 1247.50 },
    { id: 15, chemicalName: "Ammonia", vendor: "BASF", density: 682.40, viscosity: 8.90, packaging: "Cylinder", packSize: "15.00", unit: "L", quantity: 3901.73 },
    { id: 16, chemicalName: "Potassium Nitrate", vendor: "Formosa", density: 2230.55, viscosity: 44.10, packaging: "Bag", packSize: "120.00", unit: "kg", quantity: 6245.12 },
    { id: 17, chemicalName: "Sodium Carbonate", vendor: "LG Chem", density: 1535.00, viscosity: 11.90, packaging: "Bag", packSize: "100.00", unit: "kg", quantity: 7495.36 },
    { id: 18, chemicalName: "Toluene", vendor: "Sinopec", density: 867.30, viscosity: 40.11, packaging: "Barrel", packSize: "180.00", unit: "L", quantity: 5821.25 },
    { id: 19, chemicalName: "Methanol", vendor: "BASF", density: 792.00, viscosity: 24.36, packaging: "Canister", packSize: "50.00", unit: "L", quantity: 4132.88 },
    { id: 20, chemicalName: "Isopropyl Alcohol", vendor: "DowDuPont", density: 786.60, viscosity: 22.80, packaging: "Bottle", packSize: "25.00", unit: "L", quantity: 3825.19 }
  ];
...
function saveEditedData(rowIndex) {
    ...
    if (rowIndex!==null){
        ...
        const inputs1 = lastRow.querySelectorAll('input');
        const lastRowData = {
            id: parseInt(inputs1[1].value),
            chemicalName: inputs1[2].value,
            vendor: inputs1[3].value,
            density: parseFloat(inputs1[4].value),
            viscosity: parseFloat(inputs1[5].value),
            packaging: inputs1[6].value,
            packSize: inputs1[7].value,
            unit: inputs1[8].value,
            quantity: parseFloat(inputs1[9].value)
        };
        chemicalSupplies.push(lastRowData);
        localStorage.setItem('chemicalSupplies', JSON.stringify(chemicalSupplies));
    } 
}
